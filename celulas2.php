...
<head>
    ...
    <title>MCA</title>
    <!-- Mantenha apenas uma referência ao jQuery -->
...
<body>
    ...
    <!-- Corrigido para conteudoPlaceholder -->
    ...
    <script>
        document.getElementById('localSelect').addEventListener('change', async function() {
            ...
            if (valor) {
                ...
                var urlDaPagina = 'celulas2.php?bairro=' + valor; // Ajuste conforme necessário
                ...
                try {
                    ...
                    const conteudoEspecifico = html.querySelector('.' + valor); // Ex: .silveira, .imperial, .reginalice
                    
                    // Verificando se o conteúdo foi encontrado
                    if(conteudoEspecifico) {
                        // Adicionando o conteúdo ao divConteudo
                        divConteudo.appendChild(conteudoEspecifico);
                    } else {
